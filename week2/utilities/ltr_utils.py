...
def create_rescore_ltr_query(user_query, query_obj, click_prior_query, ltr_model_name, ltr_store_name,
                             active_features=None, rescore_size=500, main_query_weight=0, rescore_query_weight=2):
    ...
    query_obj['rescore'] = {
        ...
        "query": {
            ...
            "score_mode": "total",
            "query_weight": 0,          # Could mess with these values to tune?
            "rescore_query_weight": 1
        }
    }
    if active_features and len(active_features) > 0:
        query_obj['query']['bool']['should']['stlr']['active_features'] = active_features
    return query_obj
